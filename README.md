...
#### Comparison plots
Comparison plots can be generated from output data of various simulations. This inputs to the code are as follows:
```python
...
python3 plot.py
```
The code creates a folder 'plots' and stores the generated figures inside it.
